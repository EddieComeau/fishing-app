...
const sessionReviewRoutes = require('./routes/sessionReview.routes');
const sessionComparisonRoutes = require('./routes/sessionComparison.routes');
...
const spotPlanRoutes = require('./routes/spotPlan.routes');
const shareRoutes = require('./routes/share.routes');
const publicShareRoutes = require('./routes/publicShare.routes');
const intelligenceRoutes = require('./routes/intelligence.routes');
const decisionRoutes = require('./routes/decision.routes');
const tripPrepRoutes = require('./routes/tripPrep.routes');
const sessionStartRoutes = require('./routes/sessionStart.routes');
const profileRoutes = require('./routes/profile.routes');
const setupGuideRoutes = require('./routes/setupGuide.routes');
...
app.use('/api/sessions', sessionReviewRoutes);
app.use('/api/sessions', sessionComparisonRoutes);
app.use('/api/sessions', sessionsRoutes);
app.use('/api/species', speciesRoutes);
app.use('/api/score', scoreRoutes);
app.use('/api/bite-window', biteWindowRoutes);
app.use('/api/spots/saved', spotPlanRoutes);
app.use('/api/spots/saved', savedSpotsRoutes);
app.use('/api/spots', spotRoutes);
app.use('/api/share', shareRoutes);
app.use('/api/intelligence', intelligenceRoutes);
app.use('/api/decision', decisionRoutes);
app.use('/api/trip-prep', tripPrepRoutes);
app.use('/api/session-start', sessionStartRoutes);
app.use('/api/profile', profileRoutes);
app.use('/api/setup-guides', setupGuideRoutes);
